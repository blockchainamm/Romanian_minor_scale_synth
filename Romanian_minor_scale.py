# Program to generate the sounds of notes of a Romanian minor scale matching the frequencies of notes in piano
...
def load_notes(notestep, notestep1, notescale):
    ...
    # Interval of notes for a Romanian minor scale
    notes_interval = [2, 1, 3, 1, 2, 1, 2, 2] # 2 - 1 - 3 - 1 - 2 - 1 - 2
    rev_interval = [0, 2, 1, 2, 1, 3, 1, 2]
    tones_fwd, tones_rev = [], []
    
    print(f'The frequencies in Hz of ascending notes for {notescale} in the Romanian minor scale')
    ...
    print()
    print(f'The frequencies in Hz of descending notes for {notescale} as root note in the Romanian minor scale')
    ...
    # Return list of frequencies in the ascending and descending notes of the Romanian minor scale    
...
# Scale list for which the Romanian minor scale will be played in sequence
scale_list = ['C4']
